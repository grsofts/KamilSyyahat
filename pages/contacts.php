				...
				<div class="col-md-9">
					<form role="form" id="contact_form"  method="POST" action="conf/send-message.php">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="name" id="InputName" placeholder="<?= $lang['your_name'] ?>" required>
						</div>
						<div class="form-group">
							<label for="InputEmail"><?= $lang['your_email'] ?></label>
							<input type="email" class="form-control" name="email" id="InputEmail" placeholder="<?= $lang['your_email'] ?>" required>
						</div>
						<div class="form-group">
							<label for="InputMessage"><?= $lang['your_message'] ?></label>
							<textarea class="form-control" name="message" id="Message" placeholder="<?= $lang['your_message'] ?>" rows="8" required></textarea>
						</div>
				...
				<div class="col-md-3">
					<ul class="contact-info" style="width:fit-content">
						<li style="display: flex; align-items: center; gap: 10px;">
							<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" class="bi bi-telephone-fill text-success" viewBox="0 0 16 16">
						...
						<li  style="display: flex; align-items: center; gap: 10px;">
							<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" class="bi bi-geo-alt-fill text-primary" viewBox="0 0 16 16">
							<path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
							</svg>					
							<?= $address ?>
						</li>
						<li class="" style="display: flex; align-items: center; gap: 10px;">
							<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-facebook  text-primary" viewBox="0 0 16 16">
						...
						<li  style="display: flex; align-items: center; gap: 10px;">
							<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-envelope-fill text-warning" viewBox="0 0 16 16">
						...
						<li  style="display: flex; align-items: center; gap: 10px;">
								<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-instagram text-danger" viewBox="0 0 16 16">
						...
						<li  style="display: flex; align-items: center; gap: 10px;">
							<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-tiktok text-danger" viewBox="0 0 16 16">
