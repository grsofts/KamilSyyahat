...
(function () {
    ...
    draw = function () {
        ...
        grd.addColorStop(0, 'rgba(250, 175, 58, 1.000)');
        grd.addColorStop(1, 'rgba(250, 175, 58, 0.00)');
        ...
        grd = context.createLinearGradient(0.000, 0.000, 800.000, 0.000);
        grd.addColorStop(0,  'rgba(250, 175, 58, 1.000)');
        grd.addColorStop(1, 'rgba(250, 175, 58, 0.0)');
        context.strokeStyle = grd;
        // GREEN sine
        context.beginPath();
		...
		grd.addColorStop(0, 'rgba(0, 112, 186, 1.000)');
        grd.addColorStop(1, 'rgba(0, 112, 186, 0.000)');
        context.strokeStyle = grd;
        //YELLOW sine
        context.beginPath();
